...
@Component
public class TestShowAPostRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//2. Define base URL
		String url = "http://localhost:8080/employee/showB";
		
		//3. Create RequestEntity (Body + headers)
		String body = "{\"empId\":101,\"empName\":\"ABC\",\"empSal\":200.0}";
		...
		//URL, requestBody, ResponseType, anyPathVariable
		//ResponseEntity<String> response = rt.postForEntity(url, requestBody, String.class); 
		ResponseEntity<String> response = rt.exchange(url, HttpMethod.POST, requestBody, String.class); 
